        ...
        for (var j = 0; j < walls.length; j++) {
                if (i != j) {
                    ...
                    if (wall1 != null && wall2 != null) {
                        if (((POST_SCALE / PRE_SCALE * (wall1.p1.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 <= CANVAS_WIDTH && POST_SCALE / PRE_SCALE * (wall1.p1.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 >= 0) ||
                            (POST_SCALE / PRE_SCALE * (wall1.p2.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 <= CANVAS_WIDTH && POST_SCALE / PRE_SCALE * (wall1.p2.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 >= 0)) ||
                            ((POST_SCALE / PRE_SCALE * (wall2.p1.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 <= CANVAS_WIDTH && POST_SCALE / PRE_SCALE * (wall2.p1.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 >= 0) ||
                            (POST_SCALE / PRE_SCALE * (wall2.p2.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 <= CANVAS_WIDTH && POST_SCALE / PRE_SCALE * (wall2.p2.x - CANVAS_WIDTH / 2) + CANVAS_WIDTH / 2 >= 0))) {
